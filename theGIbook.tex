...
\vfill
\includegraphics[width=0.45\textwidth]{figures/pub-logo}
\end{center}
\end{fullwidth}
%\end{titlepage}
...
%\include{templates/foreword}
%\include{templates/preface}
%\include{templates/acknow}
...
%\input{templates/chapter}
%\input{templates/appendix}


\backmatter
%\include{templates/glossary}
%\include{templates/solutions}
%\include{templates/epilogue}
